...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences settings = this.getSharedPreferences(
                SyncStateContract.Constants.LISTEN_ENABLED, 0);
    ...
    protected void onResume() {
        if (updateExternalStorageState() == SyncStateContract.Constants.MEDIA_MOUNTED) {
            final List<ColorSpace.Model> listDir = FileHelper.listFiles(this);
            ...
            adapter.sort(new Comparator<ColorSpace.Model>() {
                public int compare(ColorSpace.Model arg0, ColorSpace.Model arg1) {
        ...
        } else if (updateExternalStorageState() == SyncStateContract.Constants.MEDIA_MOUNTED_READ_ONLY) {
            mScrollView2.setVisibility(TextView.VISIBLE);
            listView.setVisibility(ScrollView.GONE);
    ...
    public static int updateExternalStorageState() {
        ...
        if (Environment.MEDIA_MOUNTED.equals(state)) {
            return SyncStateContract.Constants.MEDIA_MOUNTED;
        } else if (Environment.MEDIA_MOUNTED_READ_ONLY.equals(state)) {
            return SyncStateContract.Constants.MEDIA_MOUNTED_READ_ONLY;
        } else {
            return SyncStateContract.Constants.NO_MEDIA;
        }
    }
